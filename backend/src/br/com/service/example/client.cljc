...
;;;
;;; Message Implementation of package br.com.service.example.client
;;;----------------------------------------------------------------------------------
(ns br.com.service.example.client
...
(defrecord AuthRequest-record [email password]
  ...
  pb/TypeReflection
  (gettype [this]
    "br.com.service.example.client.AuthRequest"))

(s/def :br.com.service.example.client.AuthRequest/email string?)
(s/def :br.com.service.example.client.AuthRequest/password string?)
(s/def ::AuthRequest-spec (s/keys :opt-un [:br.com.service.example.client.AuthRequest/email :br.com.service.example.client.AuthRequest/password ]))
...
(def ^:protojure.protobuf.any/record AuthRequest-meta {:type "br.com.service.example.client.AuthRequest" :decoder pb->AuthRequest})
...
(defrecord AuthResponse-record [session-id]
  ...
  pb/TypeReflection
  (gettype [this]
    "br.com.service.example.client.AuthResponse"))

(s/def :br.com.service.example.client.AuthResponse/session-id string?)
(s/def ::AuthResponse-spec (s/keys :opt-un [:br.com.service.example.client.AuthResponse/session-id ]))
...
(def ^:protojure.protobuf.any/record AuthResponse-meta {:type "br.com.service.example.client.AuthResponse" :decoder pb->AuthResponse})
